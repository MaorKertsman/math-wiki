...
3. הגבול $\lim_{x\to x_0}\displaystyle\frac{f'(x)}{g'(x)}\in\mathbb{R}^*$ קיים (סופי או $\pm\infty$)
...
2. בסביבה המנוקבת מתקיים $g'(x)\neq 0$
3. $\lim_{x\to x_0}\displaystyle\frac{f'(x)}{g'(x)}\in\mathbb{R}^*$ קיים
...
2. $g'(x)\neq 0$ בכל $(M,\infty)$
3. $\lim_{x\to\infty}\displaystyle\frac{f'(x)}{g'(x)}\in\mathbb{R}^*$ קיים
...
מקבעים $x_1\in(M,\infty)$ ומשתמשים ב[[משפט קושי]] בקטע $[x_1,x]$. מכיוון ש-$\displaystyle\frac{f'}{g'}\to L$, בוחרים $x_1$ כך שלכל $c>x_1$ מתקיים $\left|\displaystyle\frac{f'(c)}{g'(c)}-L\right|<\varepsilon$.
